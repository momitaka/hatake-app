...
export function doUndo(){
  ...
  // buildSegs/renderGrid/renderManageはjs/segments.js・js/grid.js抽出までのwindow経由の一時ブリッジ
  window.buildSegs();window.renderGrid();if(navState.seg&&document.getElementById('screen-manage').classList.contains('active'))window.renderManage();saveLS();updUndoBtn();
}
