...
import { getHarvestPhotoUrl } from './photo-utils.js';
...
export function renderArchiveDetail(el,segId){
  ...
  miniGridLabel.textContent='栽培区画の位置（完了時のマス配置）';
